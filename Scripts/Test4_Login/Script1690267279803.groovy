...
println("Username Text: " + savedUsername)
println("Password Text: " + savedPassword)

WebUI.setText(findTestObject('Object Repository/Page_Swag Labs/input_Swag Labs_user-name'), GlobalVariable.username)

WebUI.setText(findTestObject('Object Repository/Page_Swag Labs/input_Swag Labs_password'), GlobalVariable.password)
